...
$error_defs = array(
    ...
    //ERP webserivce error codes.
    'webservice_sucess' => array('number' => 5000, 'name' => 'Webserice Success', 'description' => 'Last request processed successfully.'),
    'invalid_session' => array('number' => 5001, 'name' => 'Invalid authentication', 'description' => 'Invalid authentication detail provided to CRM.'),
    'duplicate_order' => array('number' => 5002, 'name' => 'Duplicate order', 'description' => 'Order already exists with same order no.'),
    'empty_web_customer_no' => array('number' => 5003, 'name' => 'Web Customer number empty', 'description' => 'Web customer number not provided.'),
    'empty_sales_header' => array('number' => 5004, 'name' => 'Sales header empty', 'description' => 'Sale header not provided.'),
    'empty_customer_info' => array('number' => 5005, 'name' => 'Customer info empty', 'description' => 'Customer information is empty.'),
    'empty_order_no' => array('number' => 5006, 'name' => 'Order number empty ', 'description' => 'Order number is empty.'),
    'empty_ship_to_name' => array('number' => 5007, 'name' => 'Ship to Name empty', 'description' => 'Ship to name is empty.'),
    'empty_customer_type' => array('number' => 5008, 'name' => 'Web Customer number empty', 'description' => 'Web customer number not provided.'),
    'empty_customer_firstname' => array('number' => 5009, 'name' => 'Customer first name empty', 'description' => 'Customer first name is empty.'),
    'empty_customer_email' => array('number' => 5010, 'name' => 'Customer email is empty', 'description' => 'Customer email is empty.'),
    'empty_sales_line' => array('number' => 5011, 'name' => 'Sales line empty', 'description' => 'Sales line is empty.'),
    'empty_line_no' => array('number' => 5012, 'name' => 'Line no of sales line empty', 'description' => 'One or more sales line has no line no.'),
    'empty_item_code' => array('number' => 5013, 'name' => 'Item code of sales line empty', 'description' => 'One or more sales line has no item code.'),
    'empty_order_status' => array('number' => 5014, 'name' => 'Order status empty', 'description' => 'Order status is empty.'),
    'order_status_not_changable' => array('number' => 5015, 'name' => 'Order status not changable', 'description' => 'Order status is not changeable.'),
    'order_no_not_exists' => array('number' => 5016, 'name' => 'Order no not exist', 'description' => 'Order no does not exist.'),
    'error_invalid_order_status' => array('number' => 5017, 'name' => 'Invalid order status', 'description' => 'Order status is invalid.'),
);
